...
import { handleAtestiguar } from "@/veeduria/handle-atestiguar";
import { rpcAtestiguarDenuncia } from "@/veeduria/rpc-atestiguar";
...
export async function POST(request: Request): Promise<Response> {
  ...
  return handleAtestiguar(request, {
    turnstileSecret: secret,
    verify: verifyTurnstileToken,
    rpc: (input) => rpcAtestiguarDenuncia(client, input),
  });
}
