...
import { handleReportar } from "@/veeduria/handle-reportar";
import { rpcReportarDenuncia } from "@/veeduria/rpc-reportar";
...
export async function POST(request: Request): Promise<Response> {
  ...
  return handleReportar(request, {
    turnstileSecret: secret,
    verify: verifyTurnstileToken,
    rpc: (input) => rpcReportarDenuncia(client, input),
  });
}
